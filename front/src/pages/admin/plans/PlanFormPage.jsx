  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const workoutsResponse = await axios.get('https://api.temposwim.com/api/workouts');
        ...
        const workoutsWithStats = await Promise.all(
          workoutsResponse.data.map(async (workout) => {
            try {
              ...
              const setsResponse = await axios.get(`https://api.temposwim.com/api/workouts/${workout.id}/swim-sets`);
